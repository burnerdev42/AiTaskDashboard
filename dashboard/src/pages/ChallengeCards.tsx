        ...
        <div className={`page-transition ${!isLoading ? 'fade-in' : ''}`}>
            ...
            <div className="ideas-toolbar">
                <div className="ideas-toolbar-left">
                    <h2>
                        Challenges
                        <span className="ideas-total-badge">{isLoading ? 'Loading...' : `${filteredCards.length} challenges`}</span>
                    </h2>
                ...
                <div className="ideas-toolbar-actions">
                    ...
                    <button className="ideas-btn-new" onClick={handleNewChallenge} disabled={isLoading}>
                        New Challenge
                    </button>
                </div>
            </div>
            ...
            <div className="ideas-cards-grid">
                {isLoading ? (
                    ...
                    [...Array(6)].map((_, i) => (
                        <div key={i} className="idea-solution-card skeleton" style={{ padding: '24px' }}>
                            <div className="idea-card-skeleton-header">
                                <div className="skeleton" style={{ width: '120px', height: '24px', borderRadius: '12px' }}></div>
                                <div className="skeleton" style={{ width: '140px', height: '24px', borderRadius: '12px' }}></div>
                            </div>
                            <div className="idea-card-skeleton-body">
                                <div className="skeleton idea-card-skeleton-title"></div>
                                <div className="skeleton idea-card-skeleton-desc" style={{ marginBottom: '8px' }}></div>
                                <div className="skeleton idea-card-skeleton-desc" style={{ width: '60%' }}></div>
                            </div>
                            <div className="idea-card-skeleton-footer">
