...
export class MetricsController extends AbstractController {
  ...
  async getSummary() {
    ...
    return this.success({ summary: result }, 'Metrics summary retrieved successfully');
  }
  ...
  async getThroughput() {
    ...
    return this.success({ throughput: result }, 'Monthly throughput retrieved successfully');
  }
}
