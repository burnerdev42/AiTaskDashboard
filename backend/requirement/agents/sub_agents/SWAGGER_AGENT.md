...
1. **Gather Inputs:** Take `Data requirements.txt`, the schema spec files (`spec/db_models/*.md`), the schema markdown files (`schema/*.md`), and the sample data (`sample_data/*.json`) generated by the SCHEMA_AGENT.
